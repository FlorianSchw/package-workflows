...
# the existing tests' current results and the history evidence, to judge
# failing tests (outdated vs. possible bug).
ask_claude_for_tests <- function(parsed, existing_test_file, role_text, dslite_datasets, test_results, evidence, max_new_tests) {
